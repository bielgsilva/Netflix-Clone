    ...
    return (
        <header className={`${showModal ? 'header-hidden' : 'header-trans'}`} ref={header}>
            ...
            <div className="icons">
                ...
                <img src='http://occ-0-1665-3852.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABaUylZY8mQBjvqsaNma18u8OQAMHyR7wWsXFJqdXiahaHze0b3zkX_DRuvlABvM7BFfOBqpxgrYJgHQTz0MvrZkkjoMwpdPL86ty.png?r=bb8' alt="menu" className="icon-menu" onClick={handleIconModal} />
